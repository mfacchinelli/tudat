        ...
        requestedUpdates, const simulation_setup::NamedBodyMap& bodyMap )
{
    ...
    for( std::map< propagators::EnvironmentModelsToUpdate, std::vector< std::string > >::const_iterator
         updateIterator = requestedUpdates.begin( ); updateIterator != requestedUpdates.end( ); updateIterator++ )
    {
...
//                    }
                ...
                case body_rotational_state_update:
                {
                    ...
                    {
                        throw std::runtime_error(
                                    "Error when making environment model update settings, could not find rotational ephemeris or "
                                    "dependent orientation calculator of body " + updateIterator->second.at( i ) );
                    }
                    break;
                }
                case spherical_harmonic_gravity_field_update:
                {
                    ...
                    {
                        throw std::runtime_error(
                                    "Error when making environment model update settings, could not find spherical harmonic gravity "
                                    "field of body " + updateIterator->second.at( i ) );
                    }
                    break;
                }
